...
- [Loading Indicator Patterns](#loading-indicator-patterns)
  ...
  - [Blur-up (Images)](#blur-up-images)
- [Optimistic Update Strategies](#optimistic-update-strategies)
  - [Immediate UI + Reconcile](#immediate-ui--reconcile)
  - [Queue-Based](#queue-based)
  - [Optimistic with Undo](#optimistic-with-undo)
- [Prefetching Approaches](#prefetching-approaches)
  - [Route-Based](#route-based)
  - [Hover-Based](#hover-based)
  - [Viewport-Based (Intersection Observer)](#viewport-based-intersection-observer)
- [Data Fetching and Caching Libraries](#data-fetching-and-caching-libraries)
  - [TanStack Query (React)](#tanstack-query-react)
  - [VueQuery (Vue 3)](#vuequery-vue-3)
  - [SWR (React)](#swr-react)
