...
- [Navigation Layout Patterns](#navigation-layout-patterns)
  ...
  - [Combined (Top + Sidebar)](#combined-top--sidebar)
...
- [Breadcrumb Strategies](#breadcrumb-strategies)
  - [Route-Meta-Based (Auto)](#route-meta-based-auto)
  - [Manual/Configured](#manualconfigured)
  - [Hybrid](#hybrid)
- [MFE Routing Approaches](#mfe-routing-approaches)
  - [Shell-Owned Single Router](#shell-owned-single-router)
  - [Federated Routing](#federated-routing)
