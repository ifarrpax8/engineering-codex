...
- [Content Management](#content-management)
  - [i18n Message Catalogs (Recommended Default)](#i18n-message-catalogs-recommended-default)
  - [Headless CMS (For Marketing/Dynamic Content)](#headless-cms-for-marketingdynamic-content)
  - [Hardcoded Strings (Avoid)](#hardcoded-strings-avoid)
...
- [Empty State Patterns](#empty-state-patterns)
  - [Action-Oriented (CTA)](#action-oriented-cta)
  - [Informational (Explanation)](#informational-explanation)
  - [Error Recovery (Retry/Alternative)](#error-recovery-retryalternative)
- [Error Message Framework](#error-message-framework)
  - [Problem + Cause + Action Pattern](#problem-cause-action-pattern)
  - [RFC 7807 for API Errors](#rfc-7807-for-api-errors)
