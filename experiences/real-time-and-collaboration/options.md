...
- [Real-Time Transport](#real-time-transport)
  ...
  - [WebTransport (Emerging)](#webtransport-emerging)
- [Presence Implementation](#presence-implementation)
  - [Redis-Backed (Custom)](#redis-backed-custom)
  - [Firebase Presence](#firebase-presence)
  - [Custom Heartbeat Service](#custom-heartbeat-service)
- [Conflict Resolution](#conflict-resolution)
  - [Last-Write-Wins](#last-write-wins)
  - [Operational Transforms (OT)](#operational-transforms-ot)
  - [CRDTs (Yjs, Automerge)](#crdts-yjs-automerge)
  - [Application-Level Merge](#application-level-merge)
- [WebSocket Libraries](#websocket-libraries)
  - [Native WebSocket API](#native-websocket-api)
  - [SockJS (Spring)](#sockjs-spring)
  - [Socket.IO](#socketio)
