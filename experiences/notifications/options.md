...
- [In-App Notification Patterns](#in-app-notification-patterns)
  ...
  - [Notification Center/Inbox](#notification-centerinbox)
  - [Badge + Dropdown](#badge--dropdown)
  - [Banner](#banner)
- [Email Delivery Services](#email-delivery-services)
  - [SendGrid](#sendgrid)
  - [AWS SES](#aws-ses)
  - [Mailgun](#mailgun)
  - [Self-Hosted SMTP](#self-hosted-smtp)
- [Real-Time Transport](#real-time-transport)
  - [WebSocket](#websocket)
  - [SSE (Server-Sent Events)](#sse-server-sent-events)
  - [Polling](#polling)
- [Notification Orchestration](#notification-orchestration)
  - [Custom Notification Service](#custom-notification-service)
  - [Novu](#novu)
  - [Courier](#courier)
