...
- [Unauthorized Content Strategy](#unauthorized-content-strategy)
  ...
  - [Disable with Tooltip](#disable-with-tooltip)
  - [Show with "Request Access"](#show-with-request-access)
  - [Show with "Upgrade Plan"](#show-with-upgrade-plan)
- [Frontend Permission Patterns](#frontend-permission-patterns)
  - [Directive-Based (Vue v-permission)](#directive-based-vue-v-permission)
  - [Component Wrapper (PermissionGate)](#component-wrapper-permissiongate)
  - [Hook-Based (usePermission)](#hook-based-usepermission)
  - [Route-Level Guards](#route-level-guards)
- [Permission Storage](#permission-storage)
  - [Pinia/Zustand Store](#piniazustand-store)
  - [React Context](#react-context)
  - [localStorage Cache with TTL](#localstorage-cache-with-ttl)
- [Authorization Models (UI Perspective)](#authorization-models-ui-perspective)
  - [RBAC (Role-Based Show/Hide)](#rbac-role-based-showhide)
  - [ABAC (Attribute-Based Granular)](#abac-attribute-based-granular)
  - [FGA (Relationship-Based Per-Resource)](#fga-relationship-based-per-resource)
