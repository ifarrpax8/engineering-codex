...
- [Workflow Patterns](#workflow-patterns)
  ...
  - [Non-Linear Wizard](#non-linear-wizard)
  - [Approval Chain](#approval-chain)
  - [Checklist/Task List](#checklist-task-list)
  - [Background Job + Notification](#background-job--notification)
- [Progress Indicators](#progress-indicators)
  - [Stepper Component (Propulsion/MUI Stepper)](#stepper-component-propulsionmui-stepper)
  - [Progress Bar](#progress-bar)
  - [Task List with Checkmarks](#task-list-with-checkmarks)
  - [Status Badge/Timeline](#status-badge-timeline)
- [Bulk Operation Strategies](#bulk-operation-strategies)
  - [Synchronous Batch](#synchronous-batch)
  - [Async Queue](#async-queue)
  - [Streaming with Progress](#streaming-with-progress)
- [Workflow Engines](#workflow-engines)
  - [Custom State Machine](#custom-state-machine)
  - [Spring Statemachine](#spring-statemachine)
  - [Axon Sagas](#axon-sagas)
  - [BPMN (Camunda/Flowable)](#bpmn-camunda-flowable)
