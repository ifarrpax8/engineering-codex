...
- [Table Libraries](#table-libraries)
  - [TanStack Table (Vue + React)](#tanstack-table-vue--react)
  - [ag-Grid (Vue + React)](#ag-grid-vue--react)
  - [Propulsion DataTable (Internal)](#propulsion-datatable-internal)
  - [MUI DataGrid (React)](#mui-datagrid-react)
- [Pagination Strategies](#pagination-strategies)
  - [Offset-Based (Spring Data Pageable)](#offset-based-spring-data-pageable)
  - [Cursor-Based](#cursor-based)
  - [Infinite Scroll](#infinite-scroll)
  - [Client-Side Pagination](#client-side-pagination)
- [Filtering Approaches](#filtering-approaches)
  - [URL Query Params + Spring Data Specification](#url-query-params--spring-data-specification)
  - [Dedicated Filter API](#dedicated-filter-api)
  - [Client-Side Filtering](#client-side-filtering)
- [Export Strategies](#export-strategies)
  - [Client-Side CSV (Small Datasets)](#client-side-csv-small-datasets)
  - [Server-Side CSV/Excel (Large)](#server-side-csvexcel-large)
