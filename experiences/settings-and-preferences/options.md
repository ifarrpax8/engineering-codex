...
- [Theme/Appearance Systems](#themeappearance-systems)
  ...
  - [Design System Theme Provider](#design-system-theme-provider)
- [Notification Preference Models](#notification-preference-models)
  - [Global Opt-In/Opt-Out](#global-opt-inopt-out)
  - [Per-Channel Preferences](#per-channel-preferences)
  - [Per-Notification-Type Matrix](#per-notification-type-matrix)
