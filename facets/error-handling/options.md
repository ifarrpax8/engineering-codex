...
- [Backend Error Response Format Options](#backend-error-response-format-options)
  - [Option 1: RFC 7807 Problem Details (Recommended)](#option-1-rfc-7807-problem-details-recommended)
  - [Option 2: Custom JSON Format](#option-2-custom-json-format)
  - [Option 3: Plain Text / HTML Errors (Spring Boot Defaults)](#option-3-plain-text--html-errors-spring-boot-defaults)
- [Resilience Pattern Options](#resilience-pattern-options)
  - [Option 1: Retry with Exponential Backoff (Recommended)](#option-1-retry-with-exponential-backoff-recommended)
  - [Option 2: Circuit Breaker (Resilience4j)](#option-2-circuit-breaker-resilience4j)
  - [Option 3: Bulkhead](#option-3-bulkhead)
  - [Option 4: Fallback](#option-4-fallback)
- [Synergies](#synergies)
