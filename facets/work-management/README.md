...
- [CI/CD](../ci-cd/) -- Branch naming tied to tickets, deployment tracking
- [Refactoring & Extraction](../refactoring-and-extraction/) -- Managing refactoring as tracked work
- [Feature Toggles](../feature-toggles/) -- Linking toggles to work items
