...
This document maps active Pax8 Architecture Decision Records (ADRs) to Engineering Codex facets. Each entry indicates whether the decision is a **Standard** (follow unless you have a strong reason not to) or **Guidance** (recommended but flexible).

## Complete ADR Mapping

| ADR | Summary | Codex Facet | Type |
|-----|---------|-------------|------|
